    ...
    <div className="w-full min-h-screen bg-[#222831] text-[#DFD0B8] flex flex-col">
      ...
      <nav className="flex justify-between items-center px-12 py-6">
        ...
        <div className="flex gap-4">
          <button className="border border-white px-4 py-1 rounded-md">Post a Job</button>
          <button className="border border-white px-4 py-1 rounded-md">Login</button>
        </div>
      </nav>
      ...
      <section className="flex flex-1 flex-col-reverse lg:flex-row items-center justify-between px-12 py-12">
        ...
        <div className="max-w-xl">
          <img src="/src/assets/2.png" alt="Hiring Visual" className="w-full h-auto" />
        </div>
      </section>
    </div>
  );
